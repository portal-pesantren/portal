        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Portal Pesantren</span>
            </div>
            <p className="text-gray-200 mb-4">
              Platform terpercaya untuk menemukan pesantren terbaik di Indonesia.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#beranda" className="text-gray-200 hover:text-white transition-colors">
                  Beranda
                </a>
              </li>
              <li>
                <a href="#tentang" className="text-gray-200 hover:text-white transition-colors">
                  Tentang Kami
                </a>
              </li>
              <li>
                <a href="#program" className="text-gray-200 hover:text-white transition-colors">
                  Cari Pesantren
                </a>
              </li>
              <li>
                <a href="#kontak" className="text-gray-200 hover:text-white transition-colors">
                  Kontak
                </a>
              </li>
            </ul>
